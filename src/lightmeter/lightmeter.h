...
void refresh() {
  ...
  display.drawLine(0, 10, 128, 10, WHITE); // TOP LINE DIVISOR
  ...
  // battery indicator for single li-ion battery
  if (battVolts > 400) {
    // full
    display.fillRect(123, 1, 4, 7, WHITE);
  } else if (battVolts > 380) {
    // medium
    display.fillRect(123, 4, 4, 5, WHITE);
  } else if (battVolts > 360) {
    // minimum
  ...
  display.drawLine(95, linePos[0] - 1, 95, linePos[0] + 17, WHITE); // EV LINE DIVISOR
  display.setTextSize(1);
  ...
  display.drawLine(0, 55, 128, 55, WHITE); // BOTTOM LINE DIVISOR
